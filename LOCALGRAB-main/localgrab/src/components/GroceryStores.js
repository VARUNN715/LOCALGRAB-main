...
function GroceryStores() {
  ...
  return (
    ...
    <div className="container-slideform">
      <div className="carousel-container-form">
        <div className="carousel-form">
          <div className="carousel-item-form">
            <h2>Mansuk's Food</h2>
            <img src="../images/grocery/s1.jpg" alt="Shop 1" />
            <p ><Link to="/groceryForm" className="order-form-btn"><b>ORDER</b></Link></p>
          </div>
          <div className="carousel-item-form">
            <h2>A Mapket</h2>
            <img src="../images/grocery/s2.jpg" alt="Shop 2" />
            <p ><a href="../public/html/groceryOrderform.html" className="order-form-btn"><b>ORDER</b></a></p>
          </div>
          <div className="carousel-item-form">
            <h2>Anandha Stores</h2>
            <img src="../images/grocery/s3.jpg" alt="Shop 3" />
            <p ><a href="../public/html/groceryOrderform.html" className="order-form-btn"><b>ORDER</b></a></p>
          </div>
          <div className="carousel-item-form">
            <h2>Green Light Supermarket</h2>
            <img src="../images/grocery/s4.jpg" alt="Shop 4" />
            <p ><a href="../public/html/groceryOrderform.html" className="order-form-btn"><b>ORDER</b></a></p>
          </div>
          <div className="carousel-item-form">
            <h2>Praween Store</h2>
            <img src="../images/grocery/s5.jpg" alt="Shop 5" />
            <p ><a href="../public/html/groceryOrderform.html" className="order-form-btn"><b>ORDER</b></a></p>
          </div>
          <div className="carousel-item-form">
            <h2>Coming Soon</h2>
      ...
      <iframe src="https://storage.googleapis.com/maps-solutions-zuyinvhrl2/neighborhood-discovery/ipb0/neighborhood-discovery.html"
